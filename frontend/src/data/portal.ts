    ...
    const news = [
      {
        ...
        content: [
          ...
          "Berbagai praktik, tantangan, dan pengalaman yang ditemui menjadi bahan refleksi dalam mengawal target pembangunan ke depan, sekaligus melihat kembali perjalanan perencanaan ekonomi Bappenas dari masa ke masa."
        ]
      },{
        ...
        content: [
          "Sebagai tindak lanjut Keputusan Menteri PPN/Kepala Bappenas Nomor 51/M.PPN/HK/05/2026 tentang Pembentukan Tim Koordinasi Pelaksanaan Transformasi Kerthi Bali, Kementerian PPN/Bappenas bersama Pemerintah Provinsi Bali menyelenggarakan Kick Off Tim Pelaksana Transformasi Kerthi Bali pada 25–26 Juni 2026. Kegiatan ini bertujuan mengoperasionalkan Tim Pelaksana sekaligus menyelaraskan pemahaman para pemangku kepentingan dalam mengawal implementasi Peta Jalan Transformasi Ekonomi Kerthi Bali.",
          "Dalam kegiatan tersebut disepakati penguatan peran Sekretariat Transformasi Kerthi Bali (STKB) sebagai platform kolaborasi pemerintah pusat dan daerah yang berfokus pada koordinasi lintas sektor, fasilitasi penyelesaian hambatan, monitoring dan evaluasi, serta penguatan pembiayaan pembangunan. STKB berperan mengawal proyek-proyek transformasi tanpa mengambil alih fungsi Bappenas, Bappeda, maupun perangkat daerah. Selain itu, diskusi penjaringan isu strategis bersama perangkat daerah menghasilkan sejumlah isu prioritas yang akan menjadi dasar penyusunan rencana kerja dan penetapan prioritas pengawalan proyek transformasi.",
          "Kegiatan ini juga mencakup pembahasan internal mengenai pengelolaan sekretariat transformasi di daerah, yang meliputi aspek kelembagaan dan tata kelola, seperti penetapan lokasi sekretariat, mekanisme koordinasi, penyempurnaan Manual Book STKB, skema penugasan sumber daya manusia, serta rencana operasional sekretariat. Hasil pembahasan tersebut menjadi landasan untuk memastikan STKB memiliki tata kelola yang jelas, mekanisme kerja yang efektif, dan kesiapan kelembagaan dalam mendukung implementasi Transformasi Kerthi Bali secara berkelanjutan."
        ]
      },
      {
      ...
      },
      {
        ...
        content: [
          "Kementerian PPN/Bappenas bersama UNDP Indonesia berkolaborasi sebagai co-host dalam pelaksanaan lokakarya regional bertajuk Regional Workshop on ASEAN Blue Carbon and Finance Profiling pada 27-28 November 2025. Lokakarya ini merupakan bagian dari rangkaian proyek ASEAN Blue Carbon and Finance Profiling yang digagas oleh UNDP dengan dukungan pendanaan dari Pemerintah Jepang, yang bertujuan untuk memperkuat pengelolaan ekosistem karbon biru yang berkelanjutan dan mempersiapkan landasan bagi mobilisasi pendanaan ke sektor ekonomi biru di ASEAN.",
          "Proyek ini dilakukan di bawah payung ASEAN Coordinating Task Force on Blue Economy (ACTF-BE) dan memiliki tiga komponen utama, yakni Blue Carbon Profiling, Blue Finance Profiling, dan Regional Platform for Knowledge Exchange. Komponen-komponen ini nantinya dapat memberikan gambaran mengenai kekayaan dan potensi ekosistem karbon biru di negara-negara ASEAN, serta mendorong eksplorasi pembiayaan inovatif dan mendukung kolaborasi serta pembelajaran bersama mengenai karbon biru dan pendanaan biru.",
          "Peran strategis Kementerian PPN/Bappenas pada ACTF-BE, serta kembali terpilihnya Deputi Bidang Perencanaan Makro Pembangunan yang sebelumnya diemban Deputi Bidang Ekonomi, sebagai Shepherd ACTF-BE periode 2026-2027, menjadi landasan bagi UNDP untuk melibatkan Kementerian PPN/Bappenas dalam pelaksanaan lokakarya tersebut. “Melalui workshop ini, saya yakin seluruh peserta akan memperoleh pemahaman yang lebih mendalam mengenai Blue Carbon dan Blue Finance Profiling, sekaligus memperkuat semangat kolaborasi yang menjadi ciri khas kawasan kita, sehingga upaya kolektif ASEAN dalam menghadapi tantangan pembangunan Ekonomi Biru dapat dijalankan dengan lebih efektif,” ujar Deputi Bidang Perencanaan Makro Pembangunan Kementerian PPN/Bappenas Eka Chandra Buana selaku Shepherd ACTF-BE membuka lokakarya ini pada Kamis (27/11).",
          "Turut hadir Deputi Bidang Pangan, Sumber Daya Alam, dan Lingkungan Hidup Kementerian PPN/Bappenas Leonardo A.A. Teguh Sambodo selaku Lead Representative Indonesia pada ACTF-BE, memaparkan Lessons Learned from Indonesia in Advancing Blue Economy. “Kami berharap bahwa upaya pengembangan Ekonomi Biru di Indonesia dapat menjadi rujukan bagi negara-negara ASEAN, karena ASEAN Blue Economy Framework memberikan arah strategis bagi kawasan untuk menjadikan laut sebagai pendorong utama pertumbuhan. Melalui workshop ini, Indonesia mendorong negara-negara anggota untuk berbagi pengalaman dan memperluas peluang kerja sama mulai dari teknologi, pendanaan, investasi, penguatan kapasitas, akses pasar global, pembangunan infrastruktur, dialog kebijakan, maupun konservasi laut. Ekosistem karbon biru yang sehat serta pembiayaan biru yang kuat menjadi fondasi penting untuk memobilisasi investasi dan memastikan pembangunan ekonomi biru yang berkelanjutan bagi masyarakat dan generasi mendatang,” ungkap Deputi Teguh.",
          "Lokakarya yang melibatkan partisipasi dari para ahli, civitas academica, institusi terkait, serta perwakilan dari negara-negara anggota ASEAN ini, menjadi wadah bagi para ahli untuk mempresentasikan dan membahas rancangan profil, bertukar wawasan, serta mengumpulkan umpan balik terkait pengelolaan ekosistem karbon biru dan implementasi pendanaan biru inovatif dari negara masing-masing untuk memperkuat hasil akhir dari proyek tersebut. Sejak kick-off yang telah dilakukan pada tanggal 20 Mei 2025, 22 orang ahli dari seluruh negara ASEAN yang tergabung di dalam proyek ini telah menghasilkan sejumlah perkembangan substansial untuk konsep profil karbon biru dan keuangan biru, sehingga dapat rampung pada akhir 2025."
        ]
      },
      {
...
export const publications: Publication[] = [
      {
        ...
        content: [
          "Masterplan Produktivitas Nasional (MPPN) merupakan dokumen kebijakan strategis yang disusun oleh Kementerian PPN/Bappenas bersama Kementerian Ketenagakerjaan, Kementerian Dalam Negeri dan Asian Productivity Organization (APO) sebagai pedoman nasional dalam mendorong pertumbuhan ekonomi berbasis produktivitas. Dokumen ini menjadi acuan lintas kementerian/lembaga, pemerintah daerah, dunia usaha, dan akademisi untuk memperkuat Total Factor Productivity (TFP) sebagai mesin utama pertumbuhan menuju Indonesia Emas 2045.",
          "Dokumen ini disusun melalui kajian kondisi produktivitas, diskusi dengan berbagai pihak, serta site visit dan research visit ke berbagai daerah untuk melihat langsung kondisi lapangan dan tantangan produktivitas di sektor-sektor utama.",
      ...
      },
      {
        ...
        content: [
          "Transformasi menuju pembangunan ramah lingkungan menuntut standar baru dalam kerangka regulasi penganggaran baik pusat maupun daerah.",
          "Buku ini memaparkan langkah praktis penilaian dampak lingkungan dari implementasi proyek infrastruktur strategis nasional.",
          "Diterbitkan secara terbuka demi menyamakan standar evaluasi capaian target Net Zero Emission Indonesia."
        ]
      }
    ];
